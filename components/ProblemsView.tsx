...
export default function ProblemsView({ problems }: { problems: EnrichedProblem[] }) {
    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: '#0d1117' }}>
            ...
            {allTopics.map((topic) => {
              ...
              return (
                <a
                  ...
                  onMouseEnter={(e) => {
                    if (active) (e.currentTarget as HTMLElement).style.background = '#161b22';
                  }}
                  onMouseLeave={(e) => {
      ...
      <main style={{ flex: 1, padding: '2rem 2rem 4rem', maxWidth: 'calc(100% - 240px)' }}>
        ...
        <div style={{ marginBottom: '2rem', paddingBottom: '1.5rem', borderBottom: '1px solid #30363d' }}>
          <h1 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#e6edf3', margin: 0 }}>
            DSA Answers
          </h1>
